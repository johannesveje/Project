...
equation
  ...
  connect(ramp.y, valve.opening) annotation (Line(points={{-11,54},{-6,54},{-6,
          5.2},{0,5.2}}, color={0,0,127}));
  connect(from_bar.y, boundary.p_in)
    annotation (Line(points={{-43,8},{-38,8}}, color={0,0,127}));
  connect(ramp1.y, from_bar.u) annotation (Line(points={{-75,34},{-72,34},{-72,
