...
model PipeWithHeat
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor thermalConductor(G=
        20/1000) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={0,22})));
equation
  ...
  connect(fixedHeatFlow.port, thermalConductor.port_a) annotation (Line(points=
          {{-26,48},{1.77636e-015,48},{1.77636e-015,32}}, color={191,0,0}));
  connect(thermalConductor.port_b, pipeWithHeat.heatPorts_a) annotation (Line(
        points={{-1.77636e-015,12},{-1.77636e-015,2.5},{-0.1,2.5}}, color={191,
          0,0}));
